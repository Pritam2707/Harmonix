...
const Downloads = () => {
  ...
  const { playSong, getDownloadedSongs } = useMusicPlayer();
  ...
  const handlePlay = (filePath: string) => {
    playSong(filePath, { isDownload: true });
  };
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
      <View style={styles.header}>
        ...
        <Text variant="titleLarge" style={{ color: theme.colors.onBackground }}>Downloaded Songs</Text>
      </View>
